...
{
    public class RpteImpactoViewModel : BaseViewModel
    {
        public Lote Lote { get; set; }
        private IEnumerable<Producto> _Productos { get; set; }

        public RpteImpactoViewModel(Lote lote)
        {
            Lote = lote;
        }

        public RpteImpactoViewModel(Lote lote, IEnumerable<Producto> productos)
        {
            Lote = lote;
