...
{
    public class ConsultaHistoricaController : BaseController
    {
        ...
        //
        // GET: /Consulta/ConsultaHistorica/
        ...
        public ActionResult GetDetalle(GridSettingsWeb grid, long id)
        {
            ...
            var jsonData = new
            {
                ...
                rows = (
                    ...
                    {
                        id = p.Id,
                        cell = new string[] { p.LoteId.ToString(), p.Ensayo.Nombre, p.NormaUM, p.NormaVMin.ToString(), p.NormaVMax.ToString(), p.ResultadoValor.ToString(), (p.Aprobado == 1 ? "Aprobado" : "Rechazado"), p.NormaEnsayoId.ToString(), p.Id.ToString() }
                    }).ToArray()
            };
