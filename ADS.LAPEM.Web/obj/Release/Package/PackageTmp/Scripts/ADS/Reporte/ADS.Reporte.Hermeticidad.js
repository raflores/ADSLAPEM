(function (g) {
    ...
    g.Init = function () {
        ...
        $("#grid").jqGrid({
            url: '/Reporte/RpteHermeticidad/GetList',
            datatype: 'json',
            mtype: 'GET',
            ...
            gridComplete: function () {
                ...
                for (var i = 0; i < cell.length; i++) {
                    ...
                    var btnGenerar = "<div class=\"ui-state-default ui-corner-all\" onclick=\"ADS.Reporte.Hermeticidad.Generar('" + id + "');\" >" +
        ...
        $("#btnNew").click(function () {
            $.ajax({
                url: '/Reporte/RpteHermeticidad/GenerarReporte',
                type: "POST",
                data: $("#" + 'FrmRpteHermeticidad').serialize(),
        ...
        $("#btnGenerar").click(function () {
            $('form').get(0).setAttribute('action', '/Reporte/RpteHermeticidad/Generar');
        ...
        g.Cancelar = function () {
            document.location.href = "/Reporte/RpteHermeticidad/";
        }

        g.Success = function () {
            $('form').get(0).setAttribute('action', '/Reporte/RpteHermeticidad/GenerarRepo');
            $("#FrmRpteHermeticidad").submit();
        }
        ...
        //$("#btnNew").click(function () {
        //    $('form').get(0).setAttribute('action', '/Reporte/RpteHermeticidad/GenerarReporte');
        //    $("#FrmRpteHermeticidad").submit();
        //});

    };

})(ADS.Reporte.Hermeticidad = {});