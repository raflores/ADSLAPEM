(function (g) {
    ...
    g.Init = function () {
        ...
        $("#grid").jqGrid({
            url: '/Reporte/RpteRigidez/GetList',
            datatype: 'json',
            mtype: 'GET',
            ...
            gridComplete: function () {
                ...
                for (var i = 0; i < cell.length; i++) {
                    ...
                    var btnGenerar = "<div class=\"ui-state-default ui-corner-all\" onclick=\"ADS.Reporte.Rigidez.Generar('" + id + "');\" >" +
        ...
        $("#btnNew").click(function () {
            $.ajax({
                url: '/Reporte/RpteRigidez/GenerarReporte',
                type: "POST",
                data: $("#" + 'FrmRpteRigidez').serialize(),
        ...
        $("#btnGenerar").click(function () {
            $('form').get(0).setAttribute('action', '/Reporte/RpteRigidez/Generar');
        ...
        g.Cancelar = function () {
            document.location.href = "/Reporte/RpteRigidez/";
        }

        g.Success = function () {
            $('form').get(0).setAttribute('action', '/Reporte/RpteRigidez/GenerarRepo');
            $("#FrmRpteRigidez").submit();
        }
        ...
        //$("#btnNew").click(function () {
        //    $('form').get(0).setAttribute('action', '/Reporte/RpteImpacto/GenerarReporte');
        //    $("#FrmRpteImpacto").submit();
        //});
