(function (g) {
    ...
    g.Init = function () {
        ...
        $("#grid").jqGrid({
            url: '/Reporte/RpteImpacto/GetList',
            datatype: 'json',
            mtype: 'GET',
            ...
            gridComplete: function () {
                ...
                for (var i = 0; i < cell.length; i++) {
                    ...
                    var btnGenerar = "<div class=\"ui-state-default ui-corner-all\" onclick=\"ADS.Reporte.Impacto.Generar('" + id + "');\" >" +
        ...
        $("#btnNew").click(function () {
            $.ajax({
                url: '/Reporte/RpteImpacto/GenerarReporte',
                type: "POST",
                data: $("#" + 'FrmRpteImpacto').serialize(),
        ...
        $("#btnGenerar").click(function () {
            $('form').get(0).setAttribute('action', '/Reporte/RpteImpacto/Generar');
        ...
        g.Cancelar = function () {
            document.location.href = "/Reporte/RpteImpacto/";
        }

        g.Success = function () {
            $('form').get(0).setAttribute('action', '/Reporte/RpteImpacto/GenerarRepo');
